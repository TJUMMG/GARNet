...
train_roots2 = {'img': '/media/HardDisk_new/wjx/datasets/DUTS-TR/DUTS-TR-Image/',
               'gt': '/media/HardDisk_A/yuanmin/dataset/DUTS-TR/DUTS-TR-Mask/'}
